...
10. Run experimental native HF generation, streaming completions, and streaming chat with prompt decode state, KV cache history, adapter bias, sampler controls, and local generation defaults.
