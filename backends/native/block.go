...
func transformerBlockFloat32(input []float32, weights BlockWeights, spec ModelSpec, position int) ([]float32, error) {
	...
	attnOut, err := multiHeadAttentionFloat32(attnInput, weights.Attention.QValues, weights.Attention.KValues, weights.Attention.VValues, weights.Attention.OutValues, weights.Attention.QTensor, weights.Attention.KTensor, weights.Attention.VTensor, weights.Attention.OutTensor, spec, position)
	if err != nil {
